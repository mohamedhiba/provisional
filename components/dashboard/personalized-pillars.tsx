      ...
      .map((pillar) => {
        ...
        const detail =
          pillar.sessions === 0
            ...
            : `${pillar.sessions} session${pillar.sessions === 1 ? "" : "s"} logged${pillar.deepMinutes > 0 ? ` • ${pillar.deepMinutes} deep min` : ""}`;
    ...
    return (
      <div className="mt-6 rounded-[1.5rem] border border-dashed border-white/10 bg-white/[0.02] px-5 py-5">
        ...
        <p className="mt-2 text-sm leading-6 text-stone-400">
          Add your real life areas in onboarding, then use focus sessions to show
